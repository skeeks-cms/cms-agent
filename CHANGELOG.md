...
3.2.4 — 2026-09-11
-----------------
 * Скрыто сообщение об отсутствии задержек; предупреждения сохранены.
 * Описание раздела перенесено в информационный блок, отдельный H1 убран.
 * Новые миграции не требуются.

3.2.3 — 2026-09-11
-----------------
 * Раздел «Расписание»: новое название и пояснение без изменения маршрутов.
 * Фильтры по способу запуска, результату и состоянию выполнения.
 * Убрана общая остановка; исправлен отступ под блоком управления.
 * Сравнение конфигурации и базы перед загрузкой, счётчики различий и скрытие кнопки при отсутствии изменений.
 * Синхронизация только изменённых записей с сохранением активности и данных выполнения.
 * 56 изолированных проверок; новые миграции не требуются.
